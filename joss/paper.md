...
![Boxplot interface. The GUI is available in English and german, here featured by the Boxplot tab. Individual datapoint or box colors can be defined manually as shown or by inputting hex codes. Data and plot recreated from Dreher 24 Figure 10D [@Dreher2024].\label{fig:figure3}](Figure3_Bar_IGF.png)
